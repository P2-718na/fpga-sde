...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename u_a \
    op interface \
    ports { u_a_address0 { O 11 vector } u_a_ce0 { O 1 bit } u_a_we0 { O 1 bit } u_a_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'u_a'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v_a \
    op interface \
    ports { v_a_address0 { O 11 vector } v_a_ce0 { O 1 bit } v_a_we0 { O 1 bit } v_a_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'v_a'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_neuron_count \
    op interface \
    ports { neuron_count { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln196 \
    op interface \
    ports { sext_ln196 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln196_1 \
    op interface \
    ports { sext_ln196_1 { I 62 vector } } \
} "
}
...
set InstName accelerator_net_flow_control_loop_pipe_sequential_init_U
set CompName accelerator_net_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix accelerator_net_ \
}"
} else {
