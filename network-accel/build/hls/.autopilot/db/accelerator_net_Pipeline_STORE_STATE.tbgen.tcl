set moduleName accelerator_net_Pipeline_STORE_STATE
set isTopModule 0
...
set cdfgNum 10
set C_modelName {accelerator_net_Pipeline_STORE_STATE}
...
dict set ap_memory_interface_dict v_a { MEM_WIDTH 32 MEM_SIZE 8192 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 1}  }
	{ neuron_count int 32 regular  }
	{ sext_ln214 int 62 regular  }
	{ sext_ln214_1 int 62 regular  }
	{ u_a int 32 regular {array 2048 { 1 3 } 1 1 } {global 0}  }
	{ v_a int 32 regular {array 2048 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "u_ddr","offset": { "type": "dynamic","port_name": "u_ddr","bundle": "control"},"direction": "READWRITE"},{"cName": "v_ddr","offset": { "type": "dynamic","port_name": "v_ddr","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "neuron_count", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln214", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln214_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "u_a", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "v_a", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ neuron_count sc_in sc_lv 32 signal 1 } 
	{ sext_ln214 sc_in sc_lv 62 signal 2 } 
	{ sext_ln214_1 sc_in sc_lv 62 signal 3 } 
	{ u_a_address0 sc_out sc_lv 11 signal 4 } 
	{ u_a_ce0 sc_out sc_logic 1 signal 4 } 
	{ u_a_q0 sc_in sc_lv 32 signal 4 } 
	{ v_a_address0 sc_out sc_lv 11 signal 5 } 
	{ v_a_ce0 sc_out sc_logic 1 signal 5 } 
	{ v_a_q0 sc_in sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln214", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln214", "role": "default" }} , 
 	{ "name": "sext_ln214_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln214_1", "role": "default" }} , 
 	...
 	{ "name": "v_a_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v_a", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln214 { ap_none {  { sext_ln214 in_data 0 62 } } }
	sext_ln214_1 { ap_none {  { sext_ln214_1 in_data 0 62 } } }
	u_a { ap_memory {  { u_a_address0 mem_address 1 11 }  { u_a_ce0 mem_ce 1 1 }  { u_a_q0 mem_dout 0 32 } } }
	v_a { ap_memory {  { v_a_address0 mem_address 1 11 }  { v_a_ce0 mem_ce 1 1 }  { v_a_q0 mem_dout 0 32 } } }
}
