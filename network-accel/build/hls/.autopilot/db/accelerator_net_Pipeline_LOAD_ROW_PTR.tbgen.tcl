set moduleName accelerator_net_Pipeline_LOAD_ROW_PTR
set isTopModule 0
...
set cdfgNum 10
set C_modelName {accelerator_net_Pipeline_LOAD_ROW_PTR}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict row_ptr { MEM_WIDTH 32 MEM_SIZE 8196 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0}  }
	{ add_ln164 int 32 regular  }
	{ sext_ln164 int 62 regular  }
	{ row_ptr int 32 regular {array 2049 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "row_ptr_ddr","offset": { "type": "dynamic","port_name": "row_ptr_ddr","bundle": "control"},"direction": "READONLY"},{"cName": "col_idx_ddr","offset": { "type": "dynamic","port_name": "col_idx_ddr","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "add_ln164", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln164", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "row_ptr", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ add_ln164 sc_in sc_lv 32 signal 1 } 
	{ sext_ln164 sc_in sc_lv 62 signal 2 } 
	{ row_ptr_address0 sc_out sc_lv 12 signal 3 } 
	{ row_ptr_ce0 sc_out sc_logic 1 signal 3 } 
	{ row_ptr_we0 sc_out sc_logic 1 signal 3 } 
	{ row_ptr_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln164", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add_ln164", "role": "default" }} , 
 	...
 	{ "name": "row_ptr_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "row_ptr", "role": "we0" }} , 
 	{ "name": "row_ptr_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "row_ptr", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	add_ln164 { ap_none {  { add_ln164 in_data 0 32 } } }
	sext_ln164 { ap_none {  { sext_ln164 in_data 0 62 } } }
	row_ptr { ap_memory {  { row_ptr_address0 mem_address 1 12 }  { row_ptr_ce0 mem_ce 1 1 }  { row_ptr_we0 mem_we 1 1 }  { row_ptr_d0 mem_din 1 32 } } }
}
