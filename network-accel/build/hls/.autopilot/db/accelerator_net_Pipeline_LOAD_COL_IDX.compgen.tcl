...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename col_idx \
    op interface \
    ports { col_idx_address0 { O 15 vector } col_idx_ce0 { O 1 bit } col_idx_we0 { O 1 bit } col_idx_d0 { O 11 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_edge_count \
    op interface \
    ports { edge_count { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_col_idx_ddr \
    op interface \
    ports { col_idx_ddr { I 64 vector } } \
} "
}
