set moduleName accelerator_net_Pipeline_LOAD_COL_IDX
set isTopModule 0
...
set cdfgNum 10
set C_modelName {accelerator_net_Pipeline_LOAD_COL_IDX}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict col_idx { MEM_WIDTH 11 MEM_SIZE 65536 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0}  }
	{ edge_count int 32 regular  }
	{ col_idx_ddr int 64 regular  }
	{ col_idx int 11 regular {array 32768 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "row_ptr_ddr","offset": { "type": "dynamic","port_name": "row_ptr_ddr","bundle": "control"},"direction": "READONLY"},{"cName": "col_idx_ddr","offset": { "type": "dynamic","port_name": "col_idx_ddr","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "edge_count", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "col_idx_ddr", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "col_idx", "interface" : "memory", "bitwidth" : 11, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ edge_count sc_in sc_lv 32 signal 1 } 
	{ col_idx_ddr sc_in sc_lv 64 signal 2 } 
	{ col_idx_address0 sc_out sc_lv 15 signal 3 } 
	{ col_idx_ce0 sc_out sc_logic 1 signal 3 } 
	{ col_idx_we0 sc_out sc_logic 1 signal 3 } 
	{ col_idx_d0 sc_out sc_lv 11 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "edge_count", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "edge_count", "role": "default" }} , 
 	{ "name": "col_idx_ddr", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "col_idx_ddr", "role": "default" }} , 
 	...
 	{ "name": "col_idx_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "col_idx", "role": "we0" }} , 
 	{ "name": "col_idx_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "col_idx", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	edge_count { ap_none {  { edge_count in_data 0 32 } } }
	col_idx_ddr { ap_none {  { col_idx_ddr in_data 0 64 } } }
	col_idx { ap_memory {  { col_idx_address0 mem_address 1 15 }  { col_idx_ce0 mem_ce 1 1 }  { col_idx_we0 mem_we 1 1 }  { col_idx_d0 mem_din 1 11 } } }
}
