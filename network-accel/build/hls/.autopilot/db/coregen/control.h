...
#define CONTROL_ADDR_ROW_PTR_DDR_DATA   0x10
#define CONTROL_BITS_ROW_PTR_DDR_DATA   64
#define CONTROL_ADDR_COL_IDX_DDR_DATA   0x1c
#define CONTROL_BITS_COL_IDX_DDR_DATA   64
#define CONTROL_ADDR_U_DDR_DATA         0x28
#define CONTROL_BITS_U_DDR_DATA         64
#define CONTROL_ADDR_V_DDR_DATA         0x34
#define CONTROL_BITS_V_DDR_DATA         64
#define CONTROL_ADDR_NEURON_COUNT_DATA  0x40
#define CONTROL_BITS_NEURON_COUNT_DATA  32
#define CONTROL_ADDR_EDGE_COUNT_DATA    0x48
#define CONTROL_BITS_EDGE_COUNT_DATA    32
#define CONTROL_ADDR_TIMESTEPS_DATA     0x50
#define CONTROL_BITS_TIMESTEPS_DATA     32
#define CONTROL_ADDR_COMMAND_DATA       0x58
#define CONTROL_BITS_COMMAND_DATA       32
#define CONTROL_ADDR_DT_DATA            0x60
#define CONTROL_BITS_DT_DATA            32
#define CONTROL_ADDR_A_DATA             0x68
#define CONTROL_BITS_A_DATA             32
#define CONTROL_ADDR_J_DATA             0x70
#define CONTROL_BITS_J_DATA             32
#define CONTROL_ADDR_INV_E_DATA         0x78
#define CONTROL_BITS_INV_E_DATA         32
#define CONTROL_ADDR_SIGMA_SQRT_DT_DATA 0x80
#define CONTROL_BITS_SIGMA_SQRT_DT_DATA 32
#define CONTROL_ADDR_SEED_DATA          0x88
#define CONTROL_BITS_SEED_DATA          32
#define CONTROL_ADDR_RESEED_DATA        0x90
#define CONTROL_BITS_RESEED_DATA        1
