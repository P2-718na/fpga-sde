...
HLS_SOURCES = ../../../../sde-accel-test.cpp ../../../../network-accel.cpp
...
$(ObjDir)/sde-accel-test.o: ../../../../sde-accel-test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../sde-accel-test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/sde-accel-test.d

$(ObjDir)/network-accel.o: ../../../../network-accel.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../network-accel.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=accelerator_net $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/network-accel.d
