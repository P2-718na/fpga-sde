...
module accelerator_net_accelerator_net_Pipeline_LOAD_ROW_PTR (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [11:0] i_3_reg_137;
reg    ap_block_pp0_stage0_11001;
reg   [11:0] i_3_reg_137_pp0_iter1_reg;
reg   [31:0] gmem0_addr_read_reg_146;
wire   [63:0] zext_ln164_1_fu_121_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [11:0] i_fu_48;
wire   [11:0] add_ln164_1_fu_104_p2;
wire    ap_loop_init;
reg   [11:0] ap_sig_allocacmp_i_3;
wire    ap_block_pp0_stage0;
reg    row_ptr_we0_local;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
reg    row_ptr_ce0_local;
wire   [31:0] zext_ln164_fu_94_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln164_fu_98_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln164_fu_98_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        row_ptr_we0_local = 1'b1;
    end else begin
        row_ptr_we0_local = 1'b0;
    end
end
...
assign add_ln164_1_fu_104_p2 = (ap_sig_allocacmp_i_3 + 12'd1);
...
assign icmp_ln164_fu_98_p2 = (($signed(zext_ln164_fu_94_p1) < $signed(add_ln164)) ? 1'b1 : 1'b0);
...
assign row_ptr_address0 = zext_ln164_1_fu_121_p1;

assign row_ptr_ce0 = row_ptr_ce0_local;

assign row_ptr_d0 = gmem0_addr_read_reg_146;

assign row_ptr_we0 = row_ptr_we0_local;

assign zext_ln164_1_fu_121_p1 = i_3_reg_137_pp0_iter1_reg;

assign zext_ln164_fu_94_p1 = ap_sig_allocacmp_i_3;

endmodule //accelerator_net_accelerator_net_Pipeline_LOAD_ROW_PTR
