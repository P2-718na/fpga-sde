...
entity accelerator_net_accelerator_net_Pipeline_LOAD_ROW_PTR is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of accelerator_net_accelerator_net_Pipeline_LOAD_ROW_PTR is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln164_fu_98_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_3_reg_137 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal i_3_reg_137_pp0_iter1_reg : STD_LOGIC_VECTOR (11 downto 0);
    signal gmem0_addr_read_reg_146 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln164_1_fu_121_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_grp0 : BOOLEAN;
    signal i_fu_48 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal add_ln164_1_fu_104_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_3 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal row_ptr_we0_local : STD_LOGIC;
    signal ap_block_pp0_stage0_11001_grp0 : BOOLEAN;
    signal ap_block_pp0_stage0_subdone_grp0_done_reg : BOOLEAN := false;
    signal ap_block_pp0_stage0_subdone_grp0 : BOOLEAN;
    signal row_ptr_ce0_local : STD_LOGIC;
    signal zext_ln164_fu_94_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln164_fu_98_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_48 <= add_ln164_1_fu_104_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                i_3_reg_137 <= ap_sig_allocacmp_i_3;
                i_3_reg_137_pp0_iter1_reg <= i_3_reg_137;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                gmem0_addr_read_reg_146 <= m_axi_gmem0_0_RDATA;
            end if;
        end if;
    end process;
    ...
    add_ln164_1_fu_104_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv12_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln164_fu_98_p2)
    begin
        if (((icmp_ln164_fu_98_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln164_fu_98_p2 <= "1" when (signed(zext_ln164_fu_94_p1) < signed(add_ln164)) else "0";
    ...
    row_ptr_address0 <= zext_ln164_1_fu_121_p1(12 - 1 downto 0);
    row_ptr_ce0 <= row_ptr_ce0_local;

    row_ptr_ce0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
    ...
    row_ptr_d0 <= gmem0_addr_read_reg_146;
    row_ptr_we0 <= row_ptr_we0_local;

    row_ptr_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            row_ptr_we0_local <= ap_const_logic_1;
        else 
            row_ptr_we0_local <= ap_const_logic_0;
        end if; 
    end process;

    zext_ln164_1_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_3_reg_137_pp0_iter1_reg),64));
    zext_ln164_fu_94_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_3),32));
end behav;
